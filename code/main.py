...
def load_amr_model():
    model_large='/path/to/model_stog_large/'
...
def get_gpt(PREFIX_ALL):
    ...
    gpt2.load_gpt2(sess,run_name=cur_run_name,checkpoint_dir='/path/to/backup/crisis_transl_graph/data/causalbank/checkpoint')
    result_all=[]
    cause_flag='because'
    effect_flag='thus'
    for PREFIX in PREFIX_ALL:
        ...
        for PREFIX in PREFIXS:
            text =gpt2.generate(sess,
                            ...
                            checkpoint_dir='/path/to/backup/crisis_transl_graph/data/causalbank/checkpoint',
                            length=2,
                            temperature=0.8,
                            prefix=PREFIX,
                            nsamples=20,
...
configs = dict(
        model_name='/path/to/backup/pre_lm/roberta-large',
        max_length=100,
        batch_size =1,
    )
...
def load_info_model():
    ...
    info_model.load_state_dict(torch.load('/path/to/backup/crisis_transl_graph/data/info_identify/code/model_save/final/model_0.892.h5'))
